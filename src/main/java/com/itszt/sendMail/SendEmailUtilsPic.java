...
// * 使用SMTP协议发送电子邮件
// */
//public class SendEmailUtilsPic {
//
//    // 邮件发送协议
...
////                        new InternetAddress("18501944658@163.com", "张三_sohu", charset),
...
//        message.setReplyTo(InternetAddress.parse("\"" + MimeUtility.encodeText("田七") + "\" <18501944658@163.com>"));
//        // 设置优先级(1:紧急   3:普通    5:低)
...
//
//        // 正文图片
//        DataSource ds3 = new FileDataSource("src/main/resources/123131.jpg");
//        DataHandler dh3 = new DataHandler(ds3);
//        imgPart.setDataHandler(dh3);
//        imgPart.setContentID("firefoxlogo.jpg");
//
//        // html邮件内容
//        MimeMultipart htmlMultipart = new MimeMultipart("alternative");
//        htmlPart.setContent(htmlMultipart);
...
////                        "<img src='cid:firefoxlogo.jpg' /></span>"
////                , "text/html;charset=gbk");
//                "<span><img src='cid:firefoxlogo.jpg' /></span>"
//                , "text/html;charset=gbk");
